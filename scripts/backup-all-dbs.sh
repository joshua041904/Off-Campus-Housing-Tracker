...
# Delegates to backup-all-7-dbs.sh which backs up auth, listings, bookings, messaging, notification, trust, analytics.
#
# Usage: same as backup-all-7-dbs.sh
...
exec "$SCRIPT_DIR/backup-all-7-dbs.sh" "$@"
