...
menu: ## Friendly workflow menu (default target)
	...
	@echo ""
	@echo "Start here:"
	@echo "  1) make up            -> full bootstrap (cluster + TLS/JKS + infra + edge checks)"
	@echo "  2) make strict-canonical -> strict preflight canonical flow"
	@echo "  3) make test-current  -> ceiling sweep + model + HTTP3/2/1 side-by-side CSVs"
	@echo "  4) make test          -> strict-canonical + collapse-all + reports"
	@echo ""
	@echo "Quick variants:"
	@echo "  - make up-fast        -> repeat bring-up (skips deps/playwright)"
	...
	@echo ""
	@echo "Use 'make help' for full target list."
	@echo ""
