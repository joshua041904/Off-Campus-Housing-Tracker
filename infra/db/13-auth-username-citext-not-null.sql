-- Canonical username on auth.users (same as prisma migration 20260509120000_auth_username_citext_not_null).
-- Apply to auth DB: psql ... -d auth -f infra/db/13-auth-username-citext-not-null.sql
