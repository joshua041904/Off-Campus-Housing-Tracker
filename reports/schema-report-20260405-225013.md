# External DB schema report — 20260405-225013

Generated: 2026-04-05T22:50:13-04:00
...
---------+-----------------+---------
 ...
 booking | search_history  | 1968 kB
 booking | watchlist_items | 408 kB
(4 rows)
...
-----------+---------------------------+------------
 ...
 forum     | posts                     | 360 kB
 messages  | group_bans                | 48 kB
 messages  | group_members             | 136 kB
 messages  | groups                    | 112 kB
 messages  | message_attachments       | 120 kB
 messages  | message_reads             | 112 kB
 messages  | messages                  | 832 kB
...
### Actual tables (from DB)
    ...
    schema    |    table_name    |  size  
--------------+------------------+--------
 notification | notifications    | 136 kB
