...
Source directory: `/Users/tom/Off-Campus-Housing-Tracker/bench_logs/ceiling/20260326-115610/gateway/http3/vus-10-run`

Generated: 2026-03-26T15:59:20Z

| Mode | Unit | p50/med | p90 | p95 | p99 | max |
|------|------|---------|-----|-----|-----|-----|
| HTTP/2 (PROTOCOL_MODE=http2) | ms | — | — | — | — | — |
| HTTP/1.1 (GODEBUG=http2client=0 — best effort) | ms | — | — | — | — | — |
| HTTP/3 (xk6-http3: .k6-build/bin/k6-http3) | ms | 0 | 0 | 0 | — | 0 |
