...
Source directory: `/Users/tom/Off-Campus-Housing-Tracker/bench_logs/ceiling/20260326-115610/gateway/http1/vus-10-run`

Generated: 2026-03-26T15:59:45Z

| Mode | Unit | p50/med | p90 | p95 | p99 | max |
|------|------|---------|-----|-----|-----|-----|
| HTTP/2 (PROTOCOL_MODE=http2) | ms | — | — | — | — | — |
| HTTP/1.1 (GODEBUG=http2client=0 — best effort) | ms | 85.649 | 268.212 | 365.448 | — | 834.657 |
