...
Source directory: `/Users/tom/Off-Campus-Housing-Tracker/bench_logs/ceiling/20260326-122845/gateway/http1/vus-30-run`

Generated: 2026-03-26T17:41:52Z

| Mode | Unit | p50/med | p90 | p95 | p99 | max |
|------|------|---------|-----|-----|-----|-----|
| HTTP/2 (PROTOCOL_MODE=http2) | ms | — | — | — | — | — |
| HTTP/1.1 (GODEBUG=http2client=0 — best effort) | ms | 110.435 | 270.0228000000001 | 350.8306 | — | 1107.015 |
