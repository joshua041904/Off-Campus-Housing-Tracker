# External DB schema report — 20260331-112903

Generated: 2026-03-31T11:29:03-04:00
...
---------+-----------------+---------
 ...
 booking | search_history  | 1792 kB
 booking | watchlist_items | 392 kB
(4 rows)
...
### Actual tables (from DB)
    ...
    schema    |    table_name    | size  
--------------+------------------+-------
 notification | notifications    | 80 kB
