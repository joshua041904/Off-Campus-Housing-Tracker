    ...
    <section className="mx-auto grid max-w-6xl gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-4 text-4xl font-semibold leading-tight tracking-tight text-slate-950 sm:text-5xl md:text-6xl">
          Find housing with more clarity, less chaos, and better trust signals.
        </h1>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-[1.75rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <h3 className="mt-4 text-xl font-semibold text-slate-900">Act</h3>
            <p className="mt-3 text-sm leading-6 text-slate-600">
    ...
    <section className="border-t border-slate-200/70 bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
          This platform is backed by multiple services working together through
          a central gateway, keeping data ownership, routing, and system
          behavior structured and predictable.
        </p>
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
            <h3 className="text-sm font-bold uppercase tracking-[0.18em] text-teal-700">
              Gateway layer
            </h3>
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Caddy terminates HTTPS (HTTP/2 + HTTP/3). Traffic reaches the API
              gateway, which fans out to gRPC and HTTP backends with strict
              TLS/mTLS inside the cluster.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
            <h3 className="text-sm font-bold uppercase tracking-[0.18em] text-teal-700">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Listings, booking, messaging, trust, analytics, and media each own
              their contracts. Events flow to Kafka where needed; the webapp
              only sees stable HTTP APIs on one hostname.
            </p>
          </div>
          <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
            <h3 className="text-sm font-bold uppercase tracking-[0.18em] text-teal-700">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              One Postgres per domain (auth, listings, bookings, …). Listings
              store geo coordinates and structured amenities for maps and
              filters; nothing bypasses the gateway from the browser.
            </p>
          </div>
        </div>
        <pre
    ...
    <section className="bg-[#0f172a] py-16 text-white sm:py-20">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-300">
          Browse listings, create an account, and start managing your housing
          search in one place.
        </p>
